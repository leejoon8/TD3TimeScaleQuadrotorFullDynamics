...
policy_freq = 10 #Number of iterations to wait before the policy network is updated
...
plt.xlabel('Episodes')
plt.ylabel('Reward')
plt.title('Reward Curve: TD-3 Quadrotor Freq=10 test success')
plt.savefig('images/Quadrotor10Rotation1.png',dpi=300)
plt.show()
##################################################
...
plt.title('Average Reward Curve: TD-3 Quadrotor Freq=10 test success')
plt.savefig('images/Quadrotor10AverageResultsRotation1.png',dpi=300)
plt.show()
######################################
######################################
